...
export class AddSamples1593701075796 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "samples" ADD CONSTRAINT "FK_e39316814f25459f88361775fd5" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "listening" ADD CONSTRAINT "FK_5920255aa325202f07bf0fc5f25" FOREIGN KEY ("sampleId") REFERENCES "samples"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "listening" DROP CONSTRAINT "FK_5920255aa325202f07bf0fc5f25"`,
        );
        await queryRunner.query(
            `ALTER TABLE "listening" DROP CONSTRAINT "FK_9f10fa23e5a928454911ae143fc"`,
        );
        await queryRunner.query(
            `ALTER TABLE "samples" DROP CONSTRAINT "FK_e39316814f25459f88361775fd5"`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "listening" DROP COLUMN "sampleId"`,
        );
