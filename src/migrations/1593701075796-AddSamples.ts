...
export class AddSamples1593701075796 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tracks" DROP COLUMN "downloadable"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tracks" ADD "downloadable" boolean NOT NULL`);
        await queryRunner.query(`ALTER TABLE "tracks" ADD "license" character varying NOT NULL`);
