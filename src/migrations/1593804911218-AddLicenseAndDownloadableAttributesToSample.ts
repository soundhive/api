...
export class AddLicenseAndDownloadableAttributesToSample1593804911218 implements MigrationInterface {
    name = 'AddLicenseAndDownloadableAttributesToSample1593804911218'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "samples" ADD "license" character varying NOT NULL`);
